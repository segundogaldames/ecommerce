...
class productosController extends Controller
{
    ...
    public function edit($id = null)
    {
        ...
        $this->_view->assign('ruta','productos/update/' . $id);
    ...
    public function update($id = null)
    {
        ...
        $this->validaForm('productos/edit/'.$id,[
    ...
    public function add()
    {
        ...
        $this->_view->assign('ruta','productos/new');
        $this->_view->assign('producto', Session::get('dato'));
        $this->_view->assign('categorias', Categoria::select('id','nombre')->orderBy('nombre','ASC')->get());
        $this->_view->assign('enviar', $this->encrypt($this->getForm()));
    ...
    public function new()
    {
        ...
        if ($producto) {
            ...
            $this->redireccionar('productos/add');
        }
