                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="{$_layoutParams.ruta_shop}images/product-detail-01.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="{$_layoutParams.ruta_shop}images/product-detail-01.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{$_layoutParams.ruta_shop}images/product-detail-01.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-slick3" data-thumb="{$_layoutParams.ruta_shop}images/product-detail-02.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="{$_layoutParams.ruta_shop}images/product-detail-02.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{$_layoutParams.ruta_shop}images/product-detail-02.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-slick3" data-thumb="{$_layoutParams.ruta_shop}images/product-detail-03.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="{$_layoutParams.ruta_shop}images/product-detail-03.jpg" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{$_layoutParams.ruta_shop}images/product-detail-03.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
